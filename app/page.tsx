    ...
    <div className="container mx-auto p-4 sm:p-8 min-h-screen font-sans">
      ...
      <footer className="text-center mt-16 mb-8 text-xs text-gray-500">
        ...
        <p className="mt-2 flex items-center justify-center">
          Love this tool? Give it a star on <a href="https://github.com/moonheart/vmware-index" target="_blank" rel="noopener noreferrer" className="ml-1 mr-1 underline hover:text-blue-600 inline-flex items-center">
